 ...
 */
public class Level1IT extends BaseIT {
	...
	public void testLevel1_1_Linking() {
		...
		assertNotNull(page.getContent().iterator().next().getLink(Link.REL_SELF));
	}
	...
	public void testLevel1_4_IANALinkRelationUsage() {
		// When using @see CurieProvider, IANA links will not get a URI scheme
		// prefix, all others will
	}
