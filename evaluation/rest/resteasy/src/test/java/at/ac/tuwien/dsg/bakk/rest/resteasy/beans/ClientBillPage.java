...
public class ClientBillPage {
	...
	@XmlElement
	private List<ClientBill> entries = new ArrayList<>();
	@XmlElement
	private RESTServiceDiscovery links;

	public ClientBillPage(List<ClientBill> entries, int offset, int limit, long modelLimit) {
		super();
	...
	public List<ClientBill> getEntries() {
		return entries;
	}

	public void setEntries(List<ClientBill> entries) {
