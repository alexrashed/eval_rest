 ...
 */
@XmlRootElement(name = "basketPage")
@XmlSeeAlso({ ClientBasket.class })
...
public class ClientBasketPage {
	...
	@XmlElement
	private List<ClientBasket> entries = new ArrayList<>();
	@XmlElement
	private RESTServiceDiscovery links;

	public ClientBasketPage(List<ClientBasket> entries, int offset, int limit, long modelLimit) {
		super();
	...
	public List<ClientBasket> getEntries() {
		return entries;
	}

	public void setEntries(List<ClientBasket> entries) {
