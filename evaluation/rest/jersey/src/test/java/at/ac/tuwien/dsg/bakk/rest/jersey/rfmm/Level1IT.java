...
public class Level1IT {
	...
	public void testLevel1_1_Linking() {
		...
		Response response = client.target(links.get(REL_ARTICLES)).request().get();
		ArticlePage page = response.readEntity(ArticlePage.class);
		// select the first article
		Article article = page.getArticles().iterator().next();
	...
	public void testLevel1_3_AnnotationBasedLinking() {
		// declarative linking allows annotation based linking.
		// https://jersey.java.net/documentation/2.22.2/declarative-linking.html
	}
